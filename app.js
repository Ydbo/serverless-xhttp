...
// 环境变量
const UUID = process.env.UUID || 'c34e999e-a11e-41f2-82dd-a2a770d23ddd'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const DOMAIN = process.env.DOMAIN || 'db.dihao.qzz.io';                   // 域名或ip,留空将自动获取服务器ip
